...
class BenchmarkRunner:
    ...
    def load_data(self, subtask_config: Dict) -> Dict:
        ...
        dataset = load_dataset(
            ...
            cache_dir=self.config.dataset_config['cache_dir']
        )
        return dataset
    ...
    def run_subtask(self, subtask_config: Dict) -> Dict:
        ...
        for metric_name in subtask_config['metrics']:
            ...
            # score = metric_fn(predictions, inputs['labels'])
        ...
        return {
            ...
            'metrics': metrics,
            'predictions': predictions if self.config.output_config['save_raw_predictions'] else None
        }
    ...
    def save_results(self):
        ...
        output_path = Path(f"results/{self.config.name}_{timestamp}.json")
